...
public class TaskSubmitMgrImpl implements BatchMgr {
	...
	private static final String shell = "/usr/hdp/2.5.0.0-1245/spark/bin/spark-submit --master yarn-client  --num-executors 2 --driver-memory 2g --executor-memory 2g --executor-cores 2 ";
